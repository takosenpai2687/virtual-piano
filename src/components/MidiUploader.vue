<template>
  <div class="relative inline-block z-20">
    ...
    >
      <h3 class="font-bold text-gray-800" style="font-size: 1.125rem; margin-bottom: 0.75rem">
        Upload MIDI File
      </h3>
      ...
      <div v-if="converting" class="text-center" style="padding: 1rem 0">
        <div
          class="inline-block animate-spin rounded-full border-4 border-pink-600 border-t-transparent"
      ...
      <div
        ...
        style="margin-top: 0.75rem; padding: 0.75rem"
      >
