<template>
  <div
    ...
    <!-- Upload -->
    <MidiUploader @notesConverted="(notes, fileName, autoPlay) => emit('notesConverted', notes, fileName, autoPlay)" @sheetSaved="emit('sheetSaved')" />
      ...
      <Transition enter-active-class="transition-all duration-200 ease-out"
        ...
        <div v-if="showVolumeSlider"
          ...
          <div class="flex flex-col items-center" style="gap: 0.5vh; width: 3.5vh; min-width: 32px;">
            ...
            <input type="range" :value="volume" @input="emit('updateVolume', ($event.target as HTMLInputElement).valueAsNumber)" min="0" max="1" step="0.01"
            ...
            <button @click="emit('updateVolume', volume > 0 ? 0 : 0.7)"
    ...
    <!-- Play Mode Control -->
    <button @click="emit('cyclePlayMode')"
