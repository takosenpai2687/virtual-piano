<template>
  <div
    class="fixed w-full cursor-pointer z-40 group transition-all"
    ...
    >
      ...
      <div
        ...
        style="
          ...
          height: 1rem;
          box-shadow:
            0 0 0.5rem 0.125rem rgba(236, 72, 153, 0.6),
            0 0 1rem 0.25rem rgba(236, 72, 153, 0.4),
            0 0 1.5rem 0.375rem rgba(236, 72, 153, 0.2),
            0 0 2rem 0.5rem rgba(236, 72, 153, 0.1);
        "
      ></div>
    </div>
    ...
    >
      ...
      >
        ...
        <div class="absolute top-full left-1/2 transform -translate-x-1/2" style="margin-top: -1px">
          <div
            class="w-0 h-0 border-transparent border-t-pink-500/50"
            style="
